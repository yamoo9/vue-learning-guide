...
const app = createApp({
  setup() {
    ...
    const toggleButtonLabel = computed(() => isFormRender.value ? '리스트 보기' : '폼 보기')
    ...
    const comments = reactive([
      ...
      },
      {
        ...
        content: '자체 최적화 기술로 성능을 최대한 끌어올려주며, 번들된 파일 크기도 작습니다. 자체 최적화 기술로 성능을 최대한 끌어올려주며, 번들된 파일 크기도 작습니다.',
      },
    ])
    ...
    return { isFormRender, toggleButtonLabel, comments, handleChangeView }
  },
  template: /* html */ `
    <button
      type="button"
    ...
    >
      <svg fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <path v-show="isFormRender" stroke-linecap="round" stroke-linejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 0 1 0 3.75H5.625a1.875 1.875 0 0 1 0-3.75Z"></path>
        <path v-show="!isFormRender" stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z"></path>
      </svg>
    </button>
